...
from distributed_local_sgd_v1 import DistributedHierLocalHVDTrainer
...
def train():
    ...
    trainer = DistributedHierLocalHVDTrainer(model.collect_params(), args.optimizer, trainer_params, local_sgd_interval = args.local_sgd_interval)
