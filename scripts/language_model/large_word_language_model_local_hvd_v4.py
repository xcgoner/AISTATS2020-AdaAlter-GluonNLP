...
from distributed_local_sgd_v4 import DistributedHierLocalHVDTrainer
...
parser.add_argument('--seed', type=int, default=0,
                    help='random seed')
parser.add_argument('--optimizer', type=str, default='localadaalterv2',
                    help='optimizer')
...
if args.optimizer != 'localadaalterv2':
    logging.info('only works with LocalAdaAlterV2')
    args.optimizer = 'localadaalterv2'
