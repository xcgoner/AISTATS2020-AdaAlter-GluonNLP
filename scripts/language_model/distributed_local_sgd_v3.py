...
class DistributedHierLocalHVDTrainer(mx.gluon.Trainer):
    ...
    def __init__(self, params, optimizer, optimizer_params=None, local_sgd_interval=0, rescale_state = 1.0):
        ...
        self._rescale_state = rescale_state
        ...
        for i, param in reversed(list(enumerate(self._params))):
            if param.grad_req != 'null':
                ...
                if param._stype == 'default':
                    ...
                    state_array *= self._rescale_state
